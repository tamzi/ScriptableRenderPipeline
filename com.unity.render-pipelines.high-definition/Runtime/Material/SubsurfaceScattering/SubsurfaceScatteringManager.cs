...
namespace UnityEngine.Experimental.Rendering.HDPipeline
{
    public class SubsurfaceScatteringManager
    {
        ...
        public void InitSSSBuffers(GBufferManager gbufferManager, RenderPipelineSettings settings)
        {
            ...
            if (settings.supportedRenderingPath == RenderPipelineSettings.SupportedLitShaderMode.ForwardOnly) //forward only
            {
            ...
            if ((settings.supportedRenderingPath & RenderPipelineSettings.SupportedLitShaderMode.DeferredOnly) != 0) //deferred or both
            {
