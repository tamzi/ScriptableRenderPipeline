...
namespace UnityEngine.Experimental.Rendering.HDPipeline
{
    ...
    public class FrameSettings
    {
        ...
        // View
        public LitShaderMode shaderLitMode = LitShaderMode.Deferred; // TODO: Currently there is no way to strip the extra forward shaders generated by the shaders compiler, so we can switch dynamically.
