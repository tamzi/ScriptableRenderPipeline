...
namespace UnityEditor.Experimental.Rendering.HDPipeline
{
    public class LitShaderPreprocessor : BaseShaderPreprocessor
    {
        ...
        public override bool ShadersStripper(HDRenderPipelineAsset hdrpAsset, Shader shader, ShaderSnippetData snippet, ShaderCompilerData inputData)
        {
            ...
            if (hdrpAsset.renderPipelineSettings.supportedRenderingPath == RenderPipelineSettings.SupportedLitShaderMode.ForwardOnly && isGBufferPass)
                return true;
            ...
            else // Opaque
            {
                ...
                if (isDepthOnlyPass)
                {
                    ...
                    if (hdrpAsset.renderPipelineSettings.supportedRenderingPath == RenderPipelineSettings.SupportedLitShaderMode.ForwardOnly && !inputData.shaderKeywordSet.IsEnabled(m_WriteNormalBuffer))
                        return true;
                }
